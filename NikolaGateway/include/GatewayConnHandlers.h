/* 
 * File:   GatewayConnHandlers.h
 * Author: cleo
 *
 * Created on September 7, 2014, 12:43 AM
 */

#ifndef GATEWAYCONNHANDLERS_H
#define	GATEWAYCONNHANDLERS_H
...
#define GATEWAY_CONN_HANDLERS GatewayConnHandlers::getInstance()

typedef std::map<std::string, Ident>        MAP_IDENTS;

class GatewayConnHandlers : public SingletonBase<GatewayConnHandlers>, 
                            public ConnectionCallbacks, 
                            public RequestCallbacks, 
                            public ResponseCallbacks, 
                            public UpdateCallbacks {
public:
    friend class SingletonBase<GatewayConnHandlers>;
...
private:  
    GatewayConnHandlers();
    virtual ~GatewayConnHandlers() throw();
